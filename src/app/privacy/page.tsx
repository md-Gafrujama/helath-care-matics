...
export const metadata: Metadata = {
  ...
  description:
    "How HealthMatics collects, uses, and protects information - including cookies, first-party analytics, and your privacy choices.",
};
    ...
    <>
      ...
      <div className="wrap">
        <div className="thero">
          ...
          <p>
            ...
            . This policy explains how HealthMatics (published by Quore B2B
            Marketing) processes information when you visit{" "}
            <a href="https://www.healthmatics.net">www.healthmatics.net</a>.
          </p>
        </div>
      </div>
      ...
      <div className="wrap">
        <main className="prose" style={{ maxWidth: 720, fontSize: 18 }}>
          ...
          <p>
            We publish independent healthcare news, analysis, research, and
            insights for executives, technology leaders, and decision-makers
            transforming healthcare. We process limited technical and preference
            data to run the site securely, measure audience interest with your
          ...
          <p>
            ...
            <code>hm_consent</code>, ~180 days), keep the site secure, and
          ...
          <p>
            ...
            <code>hm_vid</code>, ~400 days) and send first-party page-view
          ...
          <p>
            ...
            <code>hm_attr</code>, ~90 days) with landing path, timestamp, and
          ...
          <p>
            ...
            related context you provide to deliver the HealthMatics newsletter or
          ...
          <p>
            HealthMatics · Published by Quore B2B Marketing
            <br />
            Privacy:{" "}
            <a href="mailto:editorial@healthmatics.com">editorial@healthmatics.com</a>
            <br />
