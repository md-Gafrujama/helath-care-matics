/** First-party cookie consent + analytics payload helpers for HealthMatics. */

export const CONSENT_COOKIE = "hm_consent";
export const VID_COOKIE = "hm_vid";
export const ATTR_COOKIE = "hm_attr";
